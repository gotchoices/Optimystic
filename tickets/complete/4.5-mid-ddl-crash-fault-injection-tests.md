...
prereq:
  - tickets/complete/get-block-throws-on-pending-only-metadata.md (Crash-A1's "read returns empty state" recovery case relies on this being resolved)
files:
  ...
  - tickets/fix/crash-c-partial-commit-stranded-block.md (follow-up)
----
