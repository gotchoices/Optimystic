...
Because acquisition reuses reconcile verbatim, read-repair inherits reconcile's content gate rather than trusting whichever peer answered first, and is bounded by the same 5s deadline (`RECONCILE_TIMEOUT_MS`).
